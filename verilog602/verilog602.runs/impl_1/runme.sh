...
HD_PWD='C:/Users/user/verilog602/verilog602.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab6_2_gt.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab6_2_gt.tcl -notrace
