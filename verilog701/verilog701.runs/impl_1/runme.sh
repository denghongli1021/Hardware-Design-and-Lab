...
HD_PWD='C:/Users/user/verilog701/verilog701.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log KeyboardDecoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source KeyboardDecoder.tcl -notrace
