...
set_property used_in_implementation false [get_files C:/Users/user/verilog701/verilog701.srcs/constrs_1/imports/lab7_template/lab7_constrain.xdc]

set_param ips.enableIPCacheLiteLoad 1
close [open __synthesis_is_running__ w]

synth_design -top KeyboardDecoder -part xc7a35tcpg236-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef KeyboardDecoder.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file KeyboardDecoder_utilization_synth.rpt -pb KeyboardDecoder_utilization_synth.pb"
