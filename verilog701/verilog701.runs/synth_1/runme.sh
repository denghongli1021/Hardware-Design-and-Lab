...
HD_PWD='C:/Users/user/verilog701/verilog701.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log KeyboardDecoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source KeyboardDecoder.tcl
