...
HD_PWD='C:/Users/user/2022 exam1/2022 exam1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log exam1_C.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source exam1_C.tcl -notrace
