...
HD_PWD='C:/Users/user/2022 exam1/2022 exam1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log exam1_C.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source exam1_C.tcl
