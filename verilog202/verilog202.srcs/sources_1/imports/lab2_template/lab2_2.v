...
always@(posedge clk) begin
    ...
    else if (state == INIT && in_valid) begin
        next_output_tmp[0] = in_data;
    end
...
always@(*) begin
    ...
    ENCRYPT_DATA : begin
        output_tmp[next_offset_cnt] = (next_output_tmp[next_offset_cnt] + counter_out) % 256;
        data_in = output_tmp[next_offset_cnt];
        parity_data = {data_in[7],data_in[6],data_in[5],data_in[4],r4,data_in[3],data_in[2],data_in[1],r3,data_in[0],r2,r1};
        parity_data[0] <= r1;
        parity_data[1] <= r2;
        ...
        //if (offset_cnt == 1) begin
            // output_tmp[0] = (next_output_tmp[0] + counter_out) % 256;
            // output_tmp[1] = (next_output_tmp[1] + counter_out) % 256;
            // output_tmp[2] = (next_output_tmp[2] + counter_out) % 256;
            // output_tmp[3] = (next_output_tmp[3] + counter_out) % 256;
            // output_tmp[4] = (next_output_tmp[4] + counter_out) % 256;
            // output_tmp[5] = (next_output_tmp[5] + counter_out) % 256;
            // output_tmp[6] = (next_output_tmp[6] + counter_out) % 256;
            // output_tmp[7] = (next_output_tmp[7] + counter_out) % 256;
            // data_in = output_tmp[0];
            // parity_data = {data_in[7],data_in[6],data_in[5],data_in[4],r4,data_in[3],data_in[2],data_in[1],r3,data_in[0],r2,r1};
            // parity_data[0] <= r1;
            // parity_data[1] <= r2;
            // parity_data[2] <= data_in[0];
            ...
            // parity_data[10] <= data_in[6];
            // parity_data[11] <= data_in[7];
            // output_tmp[1] = parity_data;

            // data_in = output_tmp[2];
            // parity_data = {data_in[7],data_in[6],data_in[5],data_in[4],r4,data_in[3],data_in[2],data_in[1],r3,data_in[0],r2,r1};
            // parity_data[0] <= r1;
            // parity_data[1] <= r2;
            // parity_data[2] <= data_in[0];
            ...
            // parity_data[10] <= data_in[6];
            // parity_data[11] <= data_in[7];
            // output_tmp[2] = parity_data;

            // data_in = output_tmp[3];
            // parity_data = {data_in[7],data_in[6],data_in[5],data_in[4],r4,data_in[3],data_in[2],data_in[1],r3,data_in[0],r2,r1};
            // parity_data[0] <= r1;
            // parity_data[1] <= r2;
            // parity_data[2] <= data_in[0];
            ...
            // parity_data[10] <= data_in[6];
            // parity_data[11] <= data_in[7];
            // output_tmp[3] = parity_data;

            // data_in = output_tmp[4];
            // parity_data = {data_in[7],data_in[6],data_in[5],data_in[4],r4,data_in[3],data_in[2],data_in[1],r3,data_in[0],r2,r1};
            // parity_data[0] <= r1;
            // parity_data[1] <= r2;
            // parity_data[2] <= data_in[0];
            ...
            // parity_data[10] <= data_in[6];
            // parity_data[11] <= data_in[7];
            // output_tmp[4] = parity_data;

            // data_in = output_tmp[5];
            // parity_data = {data_in[7],data_in[6],data_in[5],data_in[4],r4,data_in[3],data_in[2],data_in[1],r3,data_in[0],r2,r1};
            // parity_data[0] <= r1;
            // parity_data[1] <= r2;
            // parity_data[2] <= data_in[0];
            ...
            // parity_data[10] <= data_in[6];
            // parity_data[11] <= data_in[7];
            // output_tmp[5] = parity_data;

            // data_in = output_tmp[6];
            // parity_data = {data_in[7],data_in[6],data_in[5],data_in[4],r4,data_in[3],data_in[2],data_in[1],r3,data_in[0],r2,r1};
            // parity_data[0] <= r1;
            // parity_data[1] <= r2;
            // parity_data[2] <= data_in[0];
            ...
            // parity_data[10] <= data_in[6];
            // parity_data[11] <= data_in[7];
            // output_tmp[6] = parity_data;

            // data_in = output_tmp[7];
            // parity_data = {data_in[7],data_in[6],data_in[5],data_in[4],r4,data_in[3],data_in[2],data_in[1],r3,data_in[0],r2,r1};
            // parity_data[0] <= r1;
            // parity_data[1] <= r2;
            // parity_data[2] <= data_in[0];
            ...
            // parity_data[10] <= data_in[6];
            // parity_data[11] <= data_in[7];
            // output_tmp[7] = parity_data;

            // output_tmp[0] = next_output_tmp[0] + counter_out;
            // output_tmp[1] = next_output_tmp[1] + counter_out;
            // output_tmp[2] = next_output_tmp[2] + counter_out;
            // output_tmp[3] = next_output_tmp[3] + counter_out;
            // output_tmp[4] = next_output_tmp[4] + counter_out;
            // output_tmp[5] = next_output_tmp[5] + counter_out;
            // output_tmp[6] = next_output_tmp[6] + counter_out;
            // output_tmp[7] = next_output_tmp[7] + counter_out;
        //end
    end
    OUTPUT_DATA : begin
...
/* output data */
always @(posedge clk) begin
    if (state == INIT || state == GET_DATA) begin
        out_data <= 0;
    end
    else if (state == OUTPUT_DATA && next_offset_cnt == 0) begin
        /* determine the value of out_data under different circumstances */
        out_data <= output_tmp[0];
    end
    else if (state == OUTPUT_DATA && next_offset_cnt == 1) begin
        out_data <= output_tmp[1];
    end
    else if (state == OUTPUT_DATA && next_offset_cnt == 2) begin
        out_data <= output_tmp[2];
    end
    else if (state == OUTPUT_DATA && next_offset_cnt == 3) begin
        out_data <= output_tmp[3];
    end
    else if (state == OUTPUT_DATA && next_offset_cnt == 4) begin
        out_data <= output_tmp[4];
    end
    else if (state == OUTPUT_DATA && next_offset_cnt == 5) begin
        out_data <= output_tmp[5];
    end
    else if (state == OUTPUT_DATA && next_offset_cnt == 6) begin
        out_data <= output_tmp[6] ;
    end
    else if (state == OUTPUT_DATA && next_offset_cnt == 7) begin
        /* determine the value of out_data under different circumstances */
