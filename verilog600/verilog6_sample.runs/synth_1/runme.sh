...
HD_PWD='C:/Users/user/verilog600/verilog6_sample.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab6_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab6_1.tcl
