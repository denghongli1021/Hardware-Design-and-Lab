...
HD_PWD='C:/Users/user/verilog600/verilog6_sample.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab6_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab6_1.tcl -notrace
