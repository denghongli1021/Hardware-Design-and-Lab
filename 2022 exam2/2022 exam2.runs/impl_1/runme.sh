...
HD_PWD='C:/Users/user/2022 exam2/2022 exam2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log exam2_A.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source exam2_A.tcl -notrace
